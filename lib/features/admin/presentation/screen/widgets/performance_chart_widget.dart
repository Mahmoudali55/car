  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AdminCubit, AdminState>(
      builder: (context, state) {
        ...
        if (status.isSuccess && status.data != null && status.data!.isNotEmpty) {
          final stats = status.data!.first;
          sold = stats.sold.toDouble();
          total = stats.avaliable.toDouble() + stats.reserved.toDouble() + sold;
        }

        final double soldPerc = total > 0 ? (sold / total) * 100 : 14.2;
