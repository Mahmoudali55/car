...
class _FilterScreenState extends State<FilterScreen> {
  ...
  final Map<String, List<String>> _selectionGroups = {
    AppLocaleKey.brands: [
      'mercedes', 'bmw', 'toyota', 'tesla', 'audi', 'ford', 'hyundai', 'kia', 'mazda'
    ],
    AppLocaleKey.status: [
      AppLocaleKey.available, AppLocaleKey.unavailable, AppLocaleKey.availableOnRequest
    ],
    AppLocaleKey.engineSystem: [
      AppLocaleKey.petrol, AppLocaleKey.diesel, AppLocaleKey.hybrid, AppLocaleKey.electric
    ],
    AppLocaleKey.driveType: [
      AppLocaleKey.normal, AppLocaleKey.sport, AppLocaleKey.sand, AppLocaleKey.snow, AppLocaleKey.mud
    ],
    AppLocaleKey.bodyType: [
      'hatchback', 'sedan', 'suv', AppLocaleKey.family, AppLocaleKey.commercial, 'coupe'
    ],
    AppLocaleKey.countryOfOrigin: [
      AppLocaleKey.japan, AppLocaleKey.china, AppLocaleKey.korea, AppLocaleKey.usa, AppLocaleKey.europe
    ],
  };
        ...
        children: [
          ListView(
            ...
            children: [
              ...
              _buildRangeSlider(_yearRange, 1990, 2025, (values) => setState(() => _yearRange = values)),
              
              Gap(24.h),
              _buildCheckboxTile(AppLocaleKey.testDrive.tr(), _isTestDriveAvailable, (v) => setState(() => _isTestDriveAvailable = v!)),
              ...
              _buildRangeSlider(_priceRange, 0, 2000000, (values) => setState(() => _priceRange = values), isPrice: true),
              
              Gap(24.h),
              _buildCheckboxTile(AppLocaleKey.taxInclusive.tr(), _isTaxInclusive, (v) => setState(() => _isTaxInclusive = v!)),
              _buildCheckboxTile(AppLocaleKey.discount.tr(), _isDiscountApplied, (v) => setState(() => _isDiscountApplied = v!)),
  ...
  Widget _buildRangeSlider(RangeValues values, double min, double max, ValueChanged<RangeValues> onChanged, {bool isPrice = false}) {
    return Column(
      children: [
        Row(
          ...
          children: [
            Text(
              isPrice ? '${values.start.toInt().toString()} ${AppLocaleKey.aed.tr()}' : values.start.toInt().toString(),
              style: AppTextStyle.bodySmall(context).copyWith(color: AppColor.primaryColor(context), fontWeight: FontWeight.bold),
            ),
            Text(
              isPrice ? '${values.end.toInt().toString()} ${AppLocaleKey.aed.tr()}' : values.end.toInt().toString(),
              style: AppTextStyle.bodySmall(context).copyWith(color: AppColor.primaryColor(context), fontWeight: FontWeight.bold),
            ),
          ],
        ),
