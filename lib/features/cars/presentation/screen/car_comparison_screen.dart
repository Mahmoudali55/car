        ...
        build: (pw.Context context) => [
          pw.Header(
            ...
            child: pw.Row(
              ...
              children: [
                pw.Text('Car Comparison Report', style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold)),
          ...
          pw.Footer(
            title: pw.Text('Generated by Car App - Elite Rewards Edition', style: const pw.TextStyle(color: PdfColors.grey700)),
          ),
        ],
      ),
    );
