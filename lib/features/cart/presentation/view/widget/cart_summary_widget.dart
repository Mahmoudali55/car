...
//                   disabledBackgroundColor: AppColor.primaryColor(context).withValues(alpha: 0.35),
//                   disabledForegroundColor: AppColor.whiteColor(context).withValues(alpha: 0.6),
