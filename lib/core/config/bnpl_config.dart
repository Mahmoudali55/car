class BnplConfig {
  ...
  static const String tabbyMerchantId =
      'merchant.moyasar.test'; // Optional depending on SDK version
  ...
  static const String tamaraBaseUrl =
      'https://api-sandbox.tamara.co/'; // Use https://api.tamara.co/ for production
